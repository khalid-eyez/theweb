...
if ( ! function_exists( 'hotelgalaxy_get_default' ) ) {
	...
	function hotelgalaxy_get_default( $filter = true){
		...
		$default = array(			
			...
			'is_theme_pre_loader' => true,
			'is_menubar_search_icon' => true,
			'is_megha_menu' => false,
			'show_title' => true,
			'show_tagline' => true,
			'retina_logo' => '',
			...
			'is_home_room_section'=>true,
			'home_room_layout'=>'one',
			...
			'is_home_shortcode_section'=>true,
...
if( !function_exists('hotelgalaxy_spacing_defaults')){

	function hotelgalaxy_spacing_defaults( $filter = true ) {

		$defaults =array(
			'button_radius_top_left'=> '25',
			'button_radius_top_right'=> '25',
			'button_radius_bottom_left'=> '25',
			'button_radius_bottom_right'=> '25',
		);

		if ( $filter ) {
			return apply_filters( 'hotelgalaxy_spacing_defaults', $defaults );
		}
...
if( !function_exists('hotelgalaxy_color_defaults')){
	...
	function hotelgalaxy_color_defaults( $filter = true ) {
		...
		$defaults =array(
			...
			'footer_icon_bar_background_color'=>'#fea116',			
			...
			'footer_widget_link_hover_color'=>'#fea116',
			'footer_widget_title_underline_color'=>'#fea116',
			
			'sidebar_tag_color'=>'#fea116',		

			'home_slider_title_color'=>'#ffffff',		
			'home_slider_description_color'=>'#ffffff',	

			'seprator_color'=>'#fea116',
			'seprator_color_before'=>'#fea116',				
			...
			'home_room_button_background_color' => '#fea116',
...
if ( ! function_exists( 'hotelgalaxy_default_fonts' ) ) {
	...
	function hotelgalaxy_default_fonts( $filter = true ) {
		...
		$default = array(
			...
			'breadcrum_title_font' => 'inherit',
			'breadcrum_title_font_category' => '',
			'breadcrum_title_font_variants' => '',
			'breadcrum_title_font_weight' => 'normal',
			'breadcrum_title_font_transform' => 'none',
			'breadcrum_title_font_size' => '24',
			'mobile_breadcrum_title_font_size' => '15',	

			'breadcrum_sub_title_font' => 'inherit',
			'breadcrum_sub_title_font_category' => '',
			'breadcrum_sub_title_font_variants' => '',
			'breadcrum_sub_title_font_weight' => 'normal',
			'breadcrum_sub_title_font_transform' => 'none',
			'breadcrum_sub_title_font_size' => '15',
			'mobile_breadcrum_sub_title_font_size' => '11',			
