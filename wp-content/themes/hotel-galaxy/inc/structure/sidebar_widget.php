...
if ( ! function_exists( 'hotelgalaxy_widgets_init' ) ) {
	...
	function hotelgalaxy_widgets_init() {		
		...
		register_sidebar( array(
			...
			'before_widget' => '<aside id="%1$s" class="widget footer-widget wow fadeInUp col-md-3 col-sm-6 %2$s"><div class="widget-inner">',
			'after_widget'  => '</div></aside>',
			'before_title'  => apply_filters( 'hotelgalaxy_start_widget_title', '<h2 class="widget-title">' ),
			'after_title'   => apply_filters( 'hotelgalaxy_end_widget_title', '</h2>' ),
		) );
...
function hotelgalaxy_widget_search(){

	$args = array(			
		'before_widget' => '<aside class="widget sidebar-widget"><div class="widget-inner">',
		'after_widget'  => '</div></aside>',
		'before_title'  => apply_filters( 'hotelgalaxy_start_widget_title', '<h2 class="widget-title">' ),
		'after_title'   => apply_filters( 'hotelgalaxy_end_widget_title', '</h2>' ),
	);
