...
class Hotelgalaxy_Title_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'hotelgalaxy-customizer-title-control',  trailingslashit( get_template_directory_uri() ) . 'inc/customizer/controls/title-control/css/title-control.css', array(), HotelGalaxy_Version );
	}
