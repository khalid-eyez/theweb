...
//menubar search
$wp_customize->add_setting(	'hotel_galaxy_option[is_menubar_search_icon]',array(
	'type'    => 'option',
	'default'=>$defaults['is_menubar_search_icon'],
	'sanitize_callback'=>'hotelgalaxy_sanitize_checkbox',	
	'capability'        => 'edit_theme_options',
	)
);
$wp_customize->add_control( 'hotel_galaxy_option[is_menubar_search_icon]', array(
	'label'        => __( 'Display primary menu-bar search icon', 'hotel-galaxy'),
	'type'=>'checkbox',
	'section'    => 'hotelgalaxy_primary_navigation_layout',
	'priority' => 1,
	'settings'   => 'hotel_galaxy_option[is_menubar_search_icon]',
	) );
