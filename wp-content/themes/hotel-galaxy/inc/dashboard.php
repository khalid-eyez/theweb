		...
		<div class="wrapper">
			<div class="container">
				<header class="meta-header">
					...
					<a class="hg-handle" href="<?php echo hotelgalaxy_pro_url()?>" target="_blank"><?php esc_html_e('Hotel Galaxy', 'hotel-galaxy') ?></a>
					<span class="hg-version"><?php esc_attr( HotelGalaxy_Version ); ?></span>
			...
			<div class="container clearfix">
				<div class="row">
								...
								foreach( $modules as $module => $info ) { ?>
									...
									<div class="addons">
										...
										<div class="addon-action">
											<a href="<?php echo esc_url( $info['url'] ); ?>"><?php esc_html_e('Learn More', 'hotel-galaxy') ?></a>
										</div>
									</div>
						...
						<div class="meta-content">
							...
							<div class="sidebar-content">
								...
								<form method="post">
									...
									<p>
										<?php
										$warning = 'return confirm("' . esc_html( 'Warning: are you sure to reset your theme settings ?', 'hotel-galaxy') . '")';
										wp_nonce_field( 'hg_reset_customizer_nonce', 'hg_reset_customizer_nonce' );
										submit_button( esc_html( 'Reset Settings', 'hotel-galaxy'), 'button-primary', 'submit', false,
											array(
					...
					if( defined('HG_PREMIUM_VERSION')){
						...
						do_action( 'hg_premium_demo_impoter' );
					}
					?>
