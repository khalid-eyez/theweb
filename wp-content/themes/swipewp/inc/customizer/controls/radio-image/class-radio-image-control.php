...
if ( ! class_exists( 'Swipewp_Control_Radio_Image' ) ) {
    
    /**
	 * Radio Image control (modified radio).
    */
	class Swipewp_Control_Radio_Image extends WP_Customize_Control{
        ...
        public function enqueue() {            
            wp_enqueue_style( 'swipewp-radio-image-style', get_template_directory_uri() . '/inc/customizer/controls/radio-image/radioimage.css', null );
            wp_enqueue_script( 'swipewp-radio-image-script', get_template_directory_uri() . '/inc/customizer/controls/radio-image/radioimage.js', array( 'jquery' ), false, true );
        }
